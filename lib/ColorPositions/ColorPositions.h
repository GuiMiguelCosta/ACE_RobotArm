...
#define DEFAULT_GREEN_DEPOSIT_X 0
#define DEFAULT_GREEN_DEPOSIT_Y 23

#define DEFAULT_YELLOW_DEPOSIT_X 0
#define DEFAULT_YELLOW_DEPOSIT_Y 23

#define DEFAULT_BLUE_DEPOSIT_X 0
#define DEFAULT_BLUE_DEPOSIT_Y 23

#define DEFAULT_RED_DEPOSIT_X 0
#define DEFAULT_RED_DEPOSIT_Y 23
